...
[👉 Windows](https://github.com/Hobb8s/viergewinnt/releases/download/v0.9.3-beta/viergewinnt-server-windows.exe)  
[👉 Mac OS X](https://github.com/Hobb8s/viergewinnt/releases/download/v0.9.3-beta/viergewinnt-server-macos)  
[👉 Linux](https://github.com/Hobb8s/viergewinnt/releases/download/v0.9.3-beta/viergewinnt-server-linux)  
[🐳 Dockerimage](https://github.com/Hobb8s/viergewinnt/releases/download/v0.9.3-beta/viergewinnt-docker.tar)  
